...
<Screenshots
  items={[
    {
      src: "/screenshots/shortcut-1.jpeg",
      alt: "iCloud import screen for the wristkit shortcut with the Add Shortcut button",
      caption: "Tap Add Shortcut to import it",
    },
  ]}
/>
...
<Screenshots
  items={[
    {
      src: "/screenshots/shortcut-2.jpeg",
      alt: "Shortcuts app Automation tab with the plus button highlighted",
      caption: "Automation tab, tap +",
    },
    {
      src: "/screenshots/shortcut-3.jpeg",
      alt: "New personal automation trigger list",
      caption: "Choose Time of Day",
    },
    {
      src: "/screenshots/shortcut-4.jpeg",
      alt: "Time of Day picker set to repeat daily",
      caption: "Set the time, repeat daily",
    },
    {
      src: "/screenshots/shortcut-5.jpeg",
      alt: "Action picker choosing the wristkit shortcut to run",
      caption: "Run Shortcut, pick wristkit Sync",
    },
  ]}
/>
