...
// ─── InstallCard and EnvCard — kept temporarily for the current home page.
//     These get replaced by the new InstallSection in the next commit. ───
    ...
    <Card>
      ...
      >
        <div>
          ...
          <span style={{ color: "var(--fg-muted)" }}>npx </span>
          <span style={{ color: "var(--fg-brand)" }}>wristkit</span>
          <span> init</span>
        </div>
        <div style={{ marginTop: 6 }}>
          <span style={{ color: "var(--fg-muted)" }}>$ </span>
          <span style={{ color: "var(--fg-muted)" }}>npx wristkit </span>
          <span style={{ color: "var(--status-success)" }}>add today-activity-card</span>
        </div>
        <div style={{ marginTop: 6 }}>
          <span style={{ color: "var(--fg-muted)" }}>$ </span>
          <span style={{ color: "var(--fg-muted)" }}>npx wristkit </span>
          <span style={{ color: "var(--status-warning)" }}>shortcut</span>
        </div>
      </div>
      <CardFooter>
        <CardComment>three commands to ship</CardComment>
        <span>MIT</span>
      </CardFooter>
    </Card>
  );
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, flex: 1 }}>
        {items.map((it) => (
          <div key={it.k} style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <span style={{ color: "var(--status-success)", fontSize: 10 }}>●</span>
            <span
              style={{
                fontFamily: "var(--font-mono)",
                fontSize: 12,
